(function () {
  ...
  var projectsArray = [
    ...
    {
      id: "FullStackSaaS",
      url: "https://github.com/wissam2000/AI-platform-saas",
    },
    {
      id: "RagReactGeneration",
      url: "https://github.com/wissam2000/code_generation_rag",
    },
  ];
  ...
  const observer = new IntersectionObserver((entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        element.classList.add("animated", animationEffect);
